...
start "WhatsApp Bot" cmd /k "cd ..\whatsapp-bot-server && echo Running WhatsApp Bot Server... && node server.js"
...
start "WhatsApp Chat Bot" cmd /k "cd ..\whatsapp-bot-server && echo Running WhatsApp Chat Server... && node chatScreenServer.js"
